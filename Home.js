...
import { Text, View,StyleSheet,StatusBar,DeviceEventEmitter,ScrollView} from 'react-native';  
...
render() {
  ...
  <View style={styles.headerContainer}>
   <View style={styles.leftHeaderContainer}>
     <Text style={styles.logoText}>e-Dialer</Text>
   </View>
  ...
  >
    <Dialer tabLabel="ios-call"  />
    <Caller tabLabel="md-contacts" status={this.state.isLoading}/>
    <Getcontacts tabLabel="md-notifications" status={this.state.isLoading}/>
    <Call_logs  tabLabel="md-flame" records={this.state.dataSource} status={this.state.isLoading}/>
  </ScrollableTabView>
  </View>
 </View>
  )
